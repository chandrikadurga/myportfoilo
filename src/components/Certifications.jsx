    ...
    const certifications = [
        {
            ...
            date: 'Jan 2026',
            certificateUrl: '/certificates/Chandrika_prompt_engineering_certificate.pdf',
            skills: [
                'Crafting effective prompts for AI models',
                'Understanding LLM behavior and optimization',
                'Prompt iteration and refinement techniques',
                'Context management and instruction design',
            ],
        ...
        },
        {
            ...
            platform: 'Verified Completion',
            date: 'Nov 2025',
            certificateUrl: '/certificates/Chandrika_AI_generalist_Certificate.pdf',
            skills: [
                'Comprehensive understanding of AI fundamentals',
                'Machine learning concepts and applications',
                'AI ethics and responsible AI practices',
                'Practical AI tools and implementation strategies',
            ],
            color: 'from-gold/25 to-yellow-900/20',
        },
        {
